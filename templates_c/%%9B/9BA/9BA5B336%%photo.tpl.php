<?php /* Smarty version 2.6.27, created on 2013-06-20 00:33:24
...
?>
        <form action="/upload/">
          <tr data-imgid="<?php echo $this->_tpl_vars['value']['imgid']; ?>
">
            <td>
              <div class="btn-group">
                <a class="btn btn-danger btn-mini dropdown-toggle" data-toggle="dropdown"><i class="icon-trash icon-white"></i> Удалить</a>
                <ul class="dropdown-menu">
                  <li><a href="/upload/?delete=<?php echo $this->_tpl_vars['value']['imgid']; ?>
&amp;mainphoto=<?php echo $this->_tpl_vars['mainphoto']; ?>
&amp;entryid=<?php echo $_GET['id']; ?>
">Вы уверены?</a></li>
                </ul>
              </div>
            </td>
            <td><?php if ($this->_tpl_vars['value']['imgid'] == $this->_tpl_vars['mainphoto']): ?><a href="#" class="btn btn-mini btn-primary disabled"><i class="icon-check icon-white"></i> Главная</a><?php else: ?><a href="/upload/?new_mainphoto=<?php echo $this->_tpl_vars['value']['imgid']; ?>
&amp;entryid=<?php echo $_GET['id']; ?>
" class="btn btn-mini">Назначить</a><?php endif; ?></td>
            <td><a href="/files/fullsize/part<?php echo $this->_tpl_vars['value']['part']; ?>
/<?php echo $this->_tpl_vars['value']['imgid']; ?>
.<?php echo $this->_tpl_vars['value']['ext']; ?>
"><img src="/files/part<?php echo $this->_tpl_vars['value']['part']; ?>
/<?php echo $this->_tpl_vars['value']['imgid']; ?>
-75x75.<?php echo $this->_tpl_vars['value']['ext']; ?>
" alt="Открыть оригинал"></a></td>
            <td class="caption"><input type="text" name="caption" class="input-block-level onchange" value="<?php echo $this->_tpl_vars['value']['caption']; ?>
"></td>
            <td class="credit"><input type="text" name="credit" class="input-block-level onchange" value="<?php echo $this->_tpl_vars['value']['credit']; ?>
"></td>
            <td>
